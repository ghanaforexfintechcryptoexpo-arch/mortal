...
export default function Hero({ onShopClick, onRepairClick, onWhatsAppClick, currency }: HeroProps) {
  return (
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative rounded-2xl bg-[#121212]/90 border border-gray-800 p-6 shadow-2xl text-left backdrop-blur-xl">
                ...
                <img
                  ...
                  alt="iPhone 15 Pro"
                  className="w-full h-44 object-cover rounded-xl mb-4 filter brightness-90 border border-gray-800"
                />

                <h3 className="text-lg font-bold text-white">iPhone 15 Pro Max Titanium</h3>
                <p className="text-xs text-gray-400 mt-1 line-clamp-2">Get Apple's premier titanium flagship, ready unlocked for MTN and Telecel, backed by standard local support.</p>
