...
export default function AIChatbot({ currentTab, currency }: AIChatbotProps) {
  ...
  const handleSendMessage = async (textToSend?: string) => {
    ...
    try {
      ...
      console.error(err);
      setMessages(prev => [...prev, { role: 'model', text: "Diagnostic networks are experiencing high volume. Drop-off coordinates: Immortal Electronics, Kwame Nkrumah Avenue, Accra, Ghana." }]);
    } finally {
      setIsLoading(false);
    }
  };
