              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <img src={product.image} className="w-12 h-12 object-contain p-1 bg-white/5 rounded-lg border border-white/10" alt="" />
                    <div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-lg">
            ...
            >
              ...
              <div className="border border-gray-150 dark:border-gray-850 rounded-2xl overflow-hidden bg-gray-50 p-2 shadow-inner">
                <img src={polaroidImage} alt="Captured Spatial Composite" className="w-full h-auto object-cover rounded-xl" />
              </div>
